    ...
    def assign_task(agent: Agent) -> Task:
        return Task(
            description=(
                ...
                "At the end of the outline, include a list of reference links or citations from where the content and data were sourced."
            ),
            expected_output=(
                ...
                "- A final section listing the reference links or citations used in the outline"
            ),
            agent=agent,
